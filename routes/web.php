...
//    Route::get('/anyUrl/{id}', 'controller@function');
   Route::get('anyUrl', 'ReportController@index');
    ...
    Route::any('paymentShedule','ReportController@paymentShedule');
    ...
    Route::get('admin2/{id}', ['as' => 'admin2.delete', 'uses' => 'BillController@destroy']);
